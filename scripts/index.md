...
| `sample_pic_slide_gen.bat` | Applies a random style chain to every sample photo and assembles the results into an MP4 slideshow using bundled `slidegen.exe` from this folder. |
